"""
DevEval Prompt Builder for Claude Code Integration
...
4. Adapting the prompts to fit the needs for CLI agents like Claude Code
...
class DevEvalPromptBuilder:
    """Builds exact DevEval prompts for Claude Code integration."""
